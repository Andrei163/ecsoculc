...
let innHcp = document.querySelectorAll('.innHcp');
let innCv = document.querySelectorAll('.innCv');
let innCs = document.querySelectorAll('.innCs');
let inn3Cv = document.querySelectorAll('.inn3Cv');
let innF = document.querySelectorAll('.innF');
let innHa = document.querySelectorAll('.innHa');
let innCity = document.querySelectorAll('.innCity');
...
let select = function () {
    ...
    let calcHa = function () {
        ...
        for (let i = 0; i < innCity.length; i++) {
            innCity[i].textContent = selectCity.value;
        };
